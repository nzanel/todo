...
class Interface(ScreenManager):
    def __init__(self, **kwargs):
        ...
        Clock.schedule_once(self.fecrching_data)
    ...
    def fecrching_data(self, dt):
        try:
            ...
            for key in keys:
                ...
                delete=Custombtn(key_name=key, on_press=self.deleting, text="Delete", size_hint=(None, None), size=(dp(80), dp(80)))
    ...
    def addItem(self, obj):
        self.popup.dismiss()
        layout= BoxLayout(size_hint_y= None, height=dp(80))
        title=Custombtn(key_name=self.textInput.text, text=self.truncate_string(self.textInput.text, 10))
    ...
    def show_popup(self):
        ...
        self.popup=Popup(title="Notice Title", size_hint=(0.8, None), height=dp(180), content=layout)
        self.popup.open()
